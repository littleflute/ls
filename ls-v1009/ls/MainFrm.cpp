...
BEGIN_MESSAGE_MAP(CMainFrame, CFrameWnd)
	...
	ON_WM_CREATE()
	ON_COMMAND(ID_XDTOOLS_KBMIDI, OnXdtoolsKbmidi)
	ON_COMMAND(ID_XDTOOLS_TEST, OnXdtoolsTest)
	ON_WM_CLOSE()
	ON_WM_DESTROY()
	ON_UPDATE_COMMAND_UI(ID_XDTOOLS_KBMIDI, OnUpdateXdtoolsKbmidi)
	//}}AFX_MSG_MAP
END_MESSAGE_MAP()
...
int CMainFrame::OnCreate(LPCREATESTRUCT lpCreateStruct)
{
	...
	m_wndStatusBar.SetPaneInfo(3,IDC_STATUSBAR,SBPS_POPOUT,70);
	m_wndStatusBar.SetPaneInfo(4,IDC_STATUSBAR,SBPS_POPOUT,70);
	return 0;
}
...
UINT XdThreadProc( LPVOID lpParam )
{
	 MSG      msg;
     HWND     hwnd ;
     WNDCLASS wndclass ;
     ...
     wndclass.hInstance     = AfxGetApp()->m_hInstance;//hInstance ;
    ...
    msg.wParam ;
	UnregisterClass(szAppName,AfxGetApp()->m_hInstance);
	gbKBMidi=FALSE;
...
void CMainFrame::OnXdtoolsKbmidi() 
{
	// TODO: Add your command handler code here
	if(FALSE==gbKBMidi){
		gbKBMidi=TRUE;
		AfxBeginThread(XdThreadProc, NULL);
	}
}

void CMainFrame::OnUpdateXdtoolsKbmidi(CCmdUI* pCmdUI) 
{
	// TODO: Add your command update UI handler code here
	pCmdUI->Enable(!gbKBMidi);
}
